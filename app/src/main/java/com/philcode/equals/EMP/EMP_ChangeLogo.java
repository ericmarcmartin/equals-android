...
public class EMP_ChangeLogo extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.emp_logo);
        ...
        DatabaseReference rootRef = FirebaseDatabase.getInstance().getReference().child("Employers").child(user.getUid());
        ...
        if(filePath  != null) {
            ...
            ref.putFile(filePath).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onFailure(@NonNull Exception e){
                    progressDialog.dismiss();
                    Toast.makeText(EMP_ChangeLogo.this, "Failed" +e.getMessage(), Toast.LENGTH_SHORT).show();
                }
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (keyCode == KeyEvent.KEYCODE_BACK ) {
            AlertDialog.Builder alert =  new AlertDialog.Builder(EMP_ChangeLogo.this);
            alert.setMessage("By clicking yes, you will return to your profile.").setCancelable(false)
