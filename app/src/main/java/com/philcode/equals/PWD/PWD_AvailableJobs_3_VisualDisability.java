    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        refUser.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                refForJobs.orderByChild("typeOfDisability2").equalTo("Partial Vision Disability").addValueEventListener(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                ...
                                                if (currentTime < expirationDate) {
                                                    ...
                                                    if (b.toLowerCase().equals(z.toLowerCase())) {
                                                        ...
                                                        if (pwdSkill.equals(jobSkill)) {
                                                            ...
                                                            adapter = new PWD_AvailableJobs_MyAdapter(PWD_AvailableJobs_3_VisualDisability.this, list);
