...
public class PWD_UserInformationSample {
    ...
    public PWD_UserInformationSample() {

    }

    public PWD_UserInformationSample(String email, String typeStatus, String firstName, String lastName, String address, String city,
                                String jobSkill1, String jobSkill2, String jobSkill3, String jobSkill4, String jobSkill5,
                                String jobSkill6, String jobSkill7, String jobSkill8, String jobSkill9, String jobSkill10, String contact, String pwdnum, String typeOfDisability1, String typeOfDisability2,
                                String typeOfDisability3, String typeOfDisabilityMore, String pwdProfilePic) {
        this.email = email;
