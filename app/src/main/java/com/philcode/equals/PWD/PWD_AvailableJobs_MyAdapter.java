...
public class PWD_AvailableJobs_MyAdapter extends RecyclerView.Adapter<PWD_AvailableJobs_MyAdapter.MyViewHolder> {
    Context context;
    ArrayList<PWD_AvailableJobs_1_All_Information> availablejobsinfos;
    public PWD_AvailableJobs_MyAdapter(Context c, ArrayList<PWD_AvailableJobs_1_All_Information> p) {
        context = c;
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.displayPostDate.setText(availablejobsinfos.get(position).getPostDate());
...
//        holder.displayTypeOfDisability3.setText(availablejobsinfos.get(position).getTypeOfDisability3());
    ...
    class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView displayPostTitle, displayTypeOfDisability1, displayTypeOfDisability2, displayTypeOfDisability3, displayPostSpecialization, displayPostLocation, displayPostDescription, displayCompanyName, displayPostDate, displayExpDate;
...
//            displayPostLocation = itemView.findViewById(R.id.displayPostLocation);
